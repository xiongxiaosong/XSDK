...
/**
 * 自定义SlingActivity侧边滑动菜单辅助类
 * 
 * @author xiongxs
 * @date 2014-10-12
 */
public class XSlidingActivityHelper {

	private Activity mActivity;

	private XSlidingMenu mSlidingMenu;
	 ...
	 */
	public XSlidingActivityHelper(Activity activity) {
		mActivity = activity;
	}
	...
	public void onCreate(Bundle savedInstanceState) {
		mSlidingMenu = (XSlidingMenu) LayoutInflater.from(mActivity).inflate(R.layout.slidingmenumain, null);
	}
	...
	public void onPostCreate(Bundle savedInstanceState) {
		...
		mSlidingMenu.attachToActivity(mActivity, 
				mEnableSlide ? XSlidingMenu.SLIDING_WINDOW : XSlidingMenu.SLIDING_CONTENT);
