...
/**
 * 使用此控件需要实现 OnHeaderRefreshListener，OnFooterRefreshListener两个接口
 * 
 * @author xiongxs
 * @注意: PullToRefreshView当做父类,里面放置listview,gridview或者scrollview的布局
 *      ,PullToRefreshView 要设置android :orientation ="vertical"属性 否则,显示不正确
 */
public class PullToRefreshView extends LinearLayout {
	...
	public boolean onInterceptTouchEvent(MotionEvent e) {
		...
		case MotionEvent.ACTION_MOVE:
			...
			if (Math.abs(deltaY)>miniMoveLength&&isRefreshViewScroll(deltaY)) {
				return true;
			}
			break;
	...
	public void onHeaderRefreshComplete() {
		...
		mHeaderState = PULL_TO_REFRESH;
		setLastUpdated("最近更新:" + DateUtil.getDateAndTime());
	}
