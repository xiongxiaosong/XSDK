...
import com.xxs.sdk.menu.XSlidingMenu.OnClosedListener;
import com.xxs.sdk.menu.XSlidingMenu.OnOpenedListener;

/**
 * 自定义XSlidingMenu主视图容器
 * 
 * @author 熊小松
 * @data 2014-10-12
 */
public class XSlidingViewAbove extends ViewGroup {
	...
	private XSlidingViewBehind mViewBehind;
	//	private int mMode;
	...
	public XSlidingViewAbove(Context context) {
		this(context, null);
	}

	public XSlidingViewAbove(Context context, AttributeSet attrs) {
		super(context, attrs);
		initCustomViewAbove();
	}
	...
	public void setXSlidingViewBehind(XSlidingViewBehind cvb) {
		mViewBehind = cvb;
	}
	...
	protected int mTouchMode = XSlidingMenu.TOUCHMODE_MARGIN;
	...
	private boolean thisTouchAllowed(MotionEvent ev) {
		...
		if (isMenuOpen()) {
			...
			switch (mTouchMode) {
			case XSlidingMenu.TOUCHMODE_FULLSCREEN:
				return !isInIgnoredView(ev);
			case XSlidingMenu.TOUCHMODE_NONE:
				return false;
			case XSlidingMenu.TOUCHMODE_MARGIN:
	...
	public void scrollTo(int x, int y) {
		...
		((XSlidingMenu)getParent()).manageLayers(getPercentOpen());
	}
